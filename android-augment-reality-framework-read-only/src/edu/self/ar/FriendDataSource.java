 ...
 */
public class FriendDataSource extends NetworkDataSource {

    private static final String URL = "http://search.twitter.com/search.json";

    private static Bitmap icon = null;

    public FriendDataSource(Resources res) {
    ...
    protected void createIcon(Resources res) {
        ...
        icon = BitmapFactory.decodeResource(res, R.drawable.friend);
    }
...
//        }
        ...
        markers.add(new IconMarker("itson", 27.492036, -109.971052, 0, Color.RED, icon));
        markers.add(new IconMarker("itesca" , 27.528443, -109.922075, 0, Color.RED, icon));
